...
**Hit rate 49% → 44% (-4 pts)** — 18 scenarios × 5 runs on accounts/fireworks/models/gpt-oss-120b.

| metric | baseline | optimized | Δ (pts) |
|---|---|---|---|
| hit rate | 49% | 44% | -4 |
| arg correctness | 100% | 100% | ±0 |
| extra-call rate | 44% | 26% | -19 |
| strict success | 34% | 39% | **+4** |

## Per scenario (hit rate)

| scenario | baseline | optimized | Δ (pts) |
|---|---|---|---|
| snapshot-for-actions | 20% | 20% | ±0 |
| screenshot-visual | 0% | 20% | **+20** |
...
| press-enter | 40% | 20% | -20 |
| click-button | 20% | 0% | -20 |
| hover-element | 20% | 0% | -20 |
| network-list | 100% | 60% | -40 |
...
_Measurement cost: baseline $1.0442 + optimized $0.9122 = $1.9564 (excl. rewriter call)._
